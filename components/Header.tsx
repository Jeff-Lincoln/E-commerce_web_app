  ...
  return (
    <header className='flex flex-wrap justify-between items-center px-4 py-2'>
        ...
        <div className='flex w-full flex-wrap justify-between items-center'>
            ...
            sm:flex-none'>
                <Link href='/basket'
                className='flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-blue-500
                hover:bg-blue-700 text-white font-bold py-2 px-4 rounded '>
                    <TrolleyIcon className='w-6 h-6' />
                    {/**Span item count */}
                    <span className='absolute -top-2 -right-2 bg-red-500 text-white font-bold rounded-full
